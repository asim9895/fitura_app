...
interface FoodOptionModalProps {
  ...
  setcurrent_exercise_id: (id: string) => void;
  remove_exercise: () => void;
  current_exercise_id: string;
}

const ExerciseOptionModal: React.FC<FoodOptionModalProps> = ({
  show_options,
  setshow_options,
  setcurrent_exercise_id,
  remove_exercise,
  current_exercise_id,
}) => {
          ...
          >
            <View>
              <TouchableOpacity
                onPress={() => {
                  router.push({
                    pathname: "/exercise/edit-exercise",
                    params: { id: current_exercise_id },
                  });
                }}
                style={{
                  width: "100%",
